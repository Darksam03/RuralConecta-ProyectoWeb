...
3. **Garantizar la interoperabilidad**: Permite que cualquier cliente autorizado (inicialmente el frontend web basado en HTML5/CSS3/JavaScript Vanilla y potencialmente futuras aplicaciones móviles o quioscos comunitarios) consuma la misma fuente de verdad sin duplicar lógica de negocio.
...
flowchart LR
    ...
    Endpoints <--> ORM
    Schemas -->|"Respuesta HTTP (200 OK / JSON)"| Fetch
    ...
    class Router,Endpoints,Schemas api;
    class ORM,DB db;
```
